                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="">
                             ...
                             <section>
                                 <div class="row">
                                     <?php
                                     $sql =$pdoCV ->prepare("SELECT * FROM t_competences WHERE utilisateur_id ='1'"); // prépar la requete
                            ...
                            <div class="col-lg-12 page-header text-center">
                                <h2>COMPETENCES</h2>
                                <p>Il y a <?php echo $nbr_competences; ?> competences dans la table pour <?php echo $ligne_utilisateur['pseudo']; ?></p>
                            </div>
                            <div class="container">
                                <div class="row">
                                    <div class="col-lg-12 page-header text-center">
                                     <table class="table table-striped">
                                         <tbody>
                                             ...
                                             <tr>
                                                 ...
                                                 <td><a class="supr" href="competences.php?id_competence=<?php echo $ligne_competence['id_competence']; ?>"><span class="glyphicon glyphicon-trash"></span></a></td>;
                                             </tr>
                                             <?php } ?>
                                         </tbody>
                                     </table>
                                     ...
                                     <form action="competences.php" method="post" class="text-center">
                                         <div class="form-group">
                                             <label for="competence">Inserer</label>
                                             <input type="text" name="competence" class="form-control" id="competence" placeholder="inserez une compétence" >
                                         </div>
