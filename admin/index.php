...
}else{//l'utilisation n'est pas connecté
            ...
            <ul class="nav navbar-right top-nav">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="divider"></li>
                        <li>
                            <a href="login.php?quitter=oui"><i class="fa fa-fw fa-power-off"></i> Log Out</a>
                        </li>
                    </ul>
                </li>
            </ul>
                ...
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        ...
                        <ul id="demo" class="collapse">
                            <li>
                                <a href="competences.php">Compétence</a>
                            </li>
                            <li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                             <?php echo $ligne_utilisateur['prenom']?> <small><?php
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="panel panel-red">
                            <a href="http://amekiri.ma6tvacoder.org/front/template/public/index">
                                <div class="panel-footer">
                                    <span class="pull-left">SITE CV</span>
