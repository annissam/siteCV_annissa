                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="">
                             ...
                             <section>
                                 <div class="row">
                                     <?php
                                     $sql =$pdoCV ->prepare("SELECT * FROM t_experiences WHERE utilisateur_id ='1'"); // prépar la requete
                            ...
                            <div class="col-lg-12 page-header text-center">
                                <h2>EXPERIENCES</h2>
                                <p>Il y a <?php echo $nbr_experiences; ?> experiences dans la table pour <?php echo $ligne_utilisateur['pseudo']; ?></p>
                            </div>
                            <div class="container">
                                <div class="row">
                                    <div class="col-lg-12 page-header text-center">
                                     <table class="table table-striped">
                                         <tbody>
                                             <tr>
                                                 <th scope="col">Titre experience</th>
                                     ...
                                     <form action="experiences.php" name="experience" method="post" class="text-center">
                                         <div class="form-group">
                                             <label for="titre_e">Experience</label>
                                             <input type="text" name="titre_e" class="form-control" id="experience" placeholder="inserez une experience" >

                                             <label for="dates_e">Date</label>
                                             <input type="date" name="date_e" class="form-control" id="dates_e" >

                                             <label for="sous_titre_e">Sous-Titre</label>
                                             <input type="text" name="sous_titre_e" class="form-control" id="sous_titre_e" placeholder="inserez un sous-titre" >
